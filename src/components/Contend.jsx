...
function Contend() {
  return (
    <div className="h-[100%] my-30 flex items-center justify-between">
      ...
      <div className="w-[495px] ">
        ...
        <div>
          ...
          <div className="py-[40px]">
             <textarea className=" h-[340px] w-[445px] p-[20px] border border-gray-400 rounded-md resize-none" name="Enter" id="Enter" placeholder="Enter The Problem Or Query "></textarea>
          </div>
          <div><button className="h-[70px] w-[445px] rounded-md bg-[#6C5FBC] text-[20px] text-[#F9F9F9] font-medium font-[poppins]">Send now</button></div>
        </div>
      </div>
    </div>
  );
